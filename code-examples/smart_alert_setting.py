...
Post data to Sightline to create a smart alert that is based on Insight data.
This requires Sightline 9.0 or greater with Insight 6 or greater.
...
if __name__ == '__main__':
    ...
    API_KEY = os.getenv('SPAPITOKEN')

    if SP_LEADER is None or API_KEY is None:
        print("Set the environment variables SPLEADER and SPAPITOKEN to "
              "the hostname or IP address of your SP leader and its API "
    ...
    #
    print("Creating a new smart alert on {}.".format(SP_LEADER))
    ...
    #
    print("Checking for smart alerts.")
